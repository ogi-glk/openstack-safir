...
from safir_monitoring.common import policies
...
def authorize(context, action, target):
    """Verifies that the action is valid on the target in this context.
       :param context: safir_sqs context
...
def get_enforcer():
    ...
    # loading the safir_sqs config options will fail as those are not
    ...
    cfg.CONF(conf_args, project='safir_monitoring')
    init()
    return _ENFORCER
