...
from safir_cloud_watcher.api.v1.controllers import v1_api

CONF = cfg.CONF
CONF.import_opt('port', 'safir_cloud_watcher.api.app', 'api')
...
class APIMediaType(wtypes.Base):
    ...
    def sample(cls):
        sample = cls(
            ...
            type='application/vnd.openstack.safir_cloud_watcher-v1+json')
        return sample
